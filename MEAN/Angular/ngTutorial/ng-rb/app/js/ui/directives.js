var rbAppDirectives = angular.module('rbAppDirectives', []);

rbAppDirectives.directive('scrollSpy', function($timeout){
    return {
        restrict: 'A',
...
rbAppDirectives.directive('preventDefault', function() {
...
rbAppDirectives.directive("scrollTo", ["$window", function($window){
    return {
        restrict : "AC",
        compile : function(){
