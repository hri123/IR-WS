...
var async = require('async'),
  ...
  cloudant = Cloudant({url: 'https://ed35dc56-a8b5-409b-938f-f7b1675d3863-bluemix:538716f291af9784858619f4f3d6e3d7257aeb06546237ebe5b01a311ab7e064@ed35dc56-a8b5-409b-938f-f7b1675d3863-bluemix.cloudant.com'}),
  dbname = 'customers';
...
function createCustomer(req, res, next) {
  ...
  var cust = { id: req.query.id || req.body.id, type: 'customer', firstname:req.query.firstname || req.body.firstname, lastname:req.query.lastname || req.body.lastname, company: req.query.company || req.body.company, email: req.query.email || req.body.email};
